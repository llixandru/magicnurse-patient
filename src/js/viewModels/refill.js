    ...
    function(ko, app, moduleUtils, accUtils, Context) {
        ...
        function CustomerViewModel() {
            ...
            self.connected = function() {
                ...
                this.ssn = ko.observable("24234325667")
                this.prescription_id = ko.observable("32456556354359")
                this.refill_store = ko.observable("RH Pharmacy")
                this.refill_status = ko.observable("To be refilled")
                this.refill_date = ko.observable()
                ...
                askRefill = async() => {
                    ...
                    const raw = {
                        ...
                        refill_store: this.refill_store,
                    ...
                    fetch("https://ml6qk3ro6t3gvrvdbsgwt6iivq.apigateway.eu-frankfurt-1.oci.customer-oci.com/magicnurse/refill/", requestOptions)
